$(document).ready(function() {
	...
	$(".tab_content").hide(); // On page load hide all the contents of all
								// tabs
	$("ul.tabs li:first").addClass("active").show(); // Default to the first
														// tab
...
function after_load(args) {
	...
	//TODO hardcoing the request parameters here for easy testing of page
